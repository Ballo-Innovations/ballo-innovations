...
const PageLoading = () => {
  return (
    <div className="fixed z-[100] min-h-[100vh] min-w-[100vh] h-screen  w-screen bg-gradient-to-r from-[var(--brand-color-1)] to-[var(--brand-color-3)]">
      <div className="absolute flex-center h-screen w-screen">
        <svg
          height="250px"
          width="250px"
          viewBox="0 0 128 128"
