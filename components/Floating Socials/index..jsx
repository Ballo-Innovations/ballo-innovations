...
import balloAds_cover from "@/public/elements small/Ballo-Bag-sm.png";
...
const FloatingSocials = () => {
  ...
  return (
    ...
    >
      ...
      <Link target="_" href="https://wa.me/+260979611334" className="tooltip3">
        <svg
          xmlns="http://www.w3.org/2000/svg"
          width="20"
          height="20"
      ...
      <Link href="/works/ballo-mag" className="tooltip4">
        <Image
          src={balloAds_cover}
      ...
      >
        <svg
          ...
          viewBox="0 0 24 24"
        >
          <g className="blueIcon" fill="#5c8ea2">
            {" "}
      ...
      <Link
        target="_"
        href="https://github.com/Ballo-Innovations"
        className="tooltip7"
      >
        <svg
          xmlns="http://www.w3.org/2000/svg"
