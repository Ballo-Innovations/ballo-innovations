...
export const graphicDesignWorks = [
  ...
  { src: mining_indaba.src, width: 10, height: 9 },
  { src: insizwe_med.src, width: 3, height: 2 },
  { src: insizwe_motor_insurance.src, width: 10, height: 8 },
  { src: fiz_chess.src, width: 1, height: 1 },
  { src: bayport_banking.src, width: 5, height: 4 },
  { src: swr_congrats.src, width: 1, height: 1 },
  { src: iv_winter_tips.src, width: 5, height: 4 },
  { src: eu.src, width: 1, height: 1 },
  { src: graphic_13.src, width: 1, height: 1 },
];
